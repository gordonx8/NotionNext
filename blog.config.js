...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'da903ea1f0eb4a4582cf4a91a8b6a36d,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion.9876566.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '博客,技术,python,AI', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '萌ICP备20250068号', // 备案号 闽ICP备XXXXXX
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://icp.gov.moe/?keyword=20250068', // 备案查询链接，如果用了萌备等备案请在这里填写
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一名创业者。前某大厂产品总监，欢迎来到我的个人技术杂笔博客🎉',
